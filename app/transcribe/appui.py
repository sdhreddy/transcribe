...
class AppUI(ctk.CTk):
    ...
    def update_response_ui_threaded(self, response_generator):
        ...
        try:
            ...
            # TTS trigger moved to single point in response generation
...
def update_response_ui(responder: gr.GPTResponder,
    ...
    if response:
        ...
        textbox.see("end")
        # TTS logic completely removed from UI update loop to prevent 10ms retriggering
        # TTS is now handled only in response generation callbacks
