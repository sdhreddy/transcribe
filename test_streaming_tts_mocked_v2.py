...
def create_mock_pyaudio():
    """Create mock PyAudio module and classes."""
    ...
    mock_pyaudio_instance.get_default_output_device_info.return_value = {
        'index': 0,
    ...
    # Make PyAudio() return the instance
    mock_pyaudio_class.return_value = mock_pyaudio_instance
    
    # Set up the module
    mock_module.PyAudio = mock_pyaudio_class
...
def simulate_conversation():
    ...
    # Set up pyaudio mock BEFORE any imports
    mock_pyaudio = create_mock_pyaudio()
    sys.modules['pyaudio'] = mock_pyaudio
    
    # Import after mocking pyaudio
    try:
        # Patch the StreamingAudioPlayer
